...
let element = document.querySelector("#items_ticket")
if(element){
    errors.innerHTML = ''
}else{
    errors.innerHTML = 'К сожалению, такого билета в данный момент нет в наличии. Приносим извинения за возможные неудобства.'
}